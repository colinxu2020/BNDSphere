...
export const inputClassName =
  "w-full min-w-0 px-4 py-3 bg-surface-sunken border border-edge rounded-md focus-visible:ring-2 focus-visible:ring-brand-strong/30 focus-visible:border-brand outline-none transition-all font-medium text-content placeholder:text-content-subtle";

export const selectClassName =
  "w-full min-w-0 px-4 py-3 bg-surface-sunken border border-edge rounded-md focus-visible:ring-2 focus-visible:ring-brand-strong/30 focus-visible:border-brand outline-none transition-all font-medium text-content";
...
export function PrimaryButton({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex items-center justify-center gap-2 px-5 py-3 bg-brand hover:bg-brand-hover text-brand-on font-semibold rounded-md transition-all shadow-md shadow-brand/20 active:scale-[0.98] motion-reduce:transition-none motion-reduce:active:scale-100 disabled:opacity-70 disabled:cursor-not-allowed outline-none focus-visible:ring-4 focus-visible:ring-brand-strong/40",
        className,
      )}
    >
...
export function SecondaryButton({
  ...
  return (
    <button
      {...props}
      className={cn(
        "inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-surface-sunken hover:bg-surface-hover border border-edge text-content font-semibold rounded-md transition-all active:scale-[0.98] motion-reduce:transition-none motion-reduce:active:scale-100 disabled:opacity-60 disabled:cursor-not-allowed outline-none focus-visible:ring-4 focus-visible:ring-brand-strong/40",
        className,
      )}
    >
      {children}
