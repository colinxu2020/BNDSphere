    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-6 bg-white rounded-[2rem] border border-slate-100 shadow-sm flex flex-col gap-3">
          ...
          <span className="w-fit text-sm font-medium text-slate-500">
            角色：{ROLE_MAP[user.role]}
          </span>
        </div>
        <Link
          to="/workspace"
          className="p-6 bg-white rounded-[2rem] border border-slate-100 shadow-sm flex flex-col gap-3 hover:border-primary-100 hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.06)] transition-all"
        >
          ...
          <span className="w-fit text-sm font-medium text-primary-600 hover:text-primary-700">
            打开工作台
          </span>
        </Link>
        <Link
