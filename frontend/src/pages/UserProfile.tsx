...
import { Badge, EmptyState, PageHeader, StatusMessage, Surface } from '../components/ui/AppPrimitives';
          ...
          <div className="px-8 pb-8">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <span className="text-xs text-slate-400 font-medium">加入于 {formatDate(user.created_at)}</span>
              </div>
            </div>
            ...
            <div className="mt-8 p-5 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <p className="text-slate-600 leading-relaxed">{user.description || '暂无个人简介。'}</p>
            </div>
          </div>
        </Surface>
      ) : (
