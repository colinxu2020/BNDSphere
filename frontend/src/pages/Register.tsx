    ...
    >
      <div className="w-full max-w-md bg-surface p-8 rounded-md border border-edge-subtle shadow-sm relative overflow-hidden">
        <div className="flex flex-col gap-2 mb-8 text-center relative z-10">
          ...
          <h1 className="text-2xl font-display font-bold text-content">注册 BNDSphere</h1>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-5 relative z-10">
          ...
          <div>
            <label className="block text-sm font-medium text-content mb-1.5 ml-1">确认密码</label>
            <input
              type="password"
