  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mt-4">
        ...
        <Link
          to="/clubs/new"
          className="inline-flex items-center justify-center gap-2 px-5 py-3 bg-primary-500 hover:bg-primary-600 text-white rounded-xl font-semibold shadow-md shadow-primary-500/20 transition-all active:scale-[0.98]"
        >
          <Plus size={18} /> 创建社团
        </Link>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="relative w-full">
          ...
          <input
            type="text"
            className="block w-full pl-11 pr-4 py-3 bg-white border border-slate-200 rounded-2xl shadow-sm focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all font-medium text-slate-900 placeholder:text-slate-400 focus:outline-none"
