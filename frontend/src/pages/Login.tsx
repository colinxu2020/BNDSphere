...
import { client, markAuthenticated } from "../api/client";
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (data?.access_token) {
        // The session arrives as an HttpOnly cookie the browser stores by
        // itself; the token in the body is for non-browser clients. All this
        // page records is that a session now exists.
        markAuthenticated();
        navigate("/profile");
      } else {
