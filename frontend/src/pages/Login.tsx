  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-white p-8 rounded-[2rem] border border-slate-100 shadow-[0_8px_30px_-4px_rgba(0,0,0,0.06)] relative overflow-hidden">
        ...
        {error && <div className="mb-6 relative z-10"><StatusMessage value={error} /></div>}
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5 relative z-10">
          ...
          <div className="mt-4 text-center text-sm text-slate-500">
            没有账号？ <span onClick={() => navigate('/register')} className="text-primary-600 hover:text-primary-700 font-medium cursor-pointer">立即注册</span>
          </div>
        </form>
      </div>
    </motion.div>
