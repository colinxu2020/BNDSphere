...
export interface paths {
    ...
    "/api/v1/clubs/summary": {
        ...
        /**
         * List Clubs Summary
         * @description Search clubs, card/list representation.
         *
         ...
         */
        get: operations["list_clubs_summary_api_v1_clubs_summary_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/moderations/summary": {
        ...
        /**
         * Get Moderation Pending Summary
         * @description Pending counts per moderation queue.
         *
         ...
         */
        get: operations["get_moderation_pending_summary_api_v1_moderations_summary_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * ClubSummaryInfo
         * @description Card/list representation of a club.
         *
        ...
        ModerationPendingSummary: {
            ...
            user_update_requests: number;
            /** Club Update Requests */
            club_update_requests: number;
            /** Club Activity Create Requests */
            club_activity_create_requests: number;
            /** Club Activity Update Requests */
            club_activity_update_requests: number;
            /** Total */
            total: number;
        };
        /**
        ...
        Page_ClubSummaryInfo_: {
            /** Items */
            items: components["schemas"]["ClubSummaryInfo"][];
            /** Total */
            total: number;
            /** Page */
            page: number;
         ...
         * @enum {string}
         */
        UploadScene: "avatar" | "club_logo" | "activity_poster" | "application_file";
        /** UserCreate */
        UserCreate: {
            /** Username */
            username: string;
         ...
         * @enum {string}
         */
        UserGradeEnum: "grade_7" | "grade_8" | "grade_9" | "grade_10" | "grade_11" | "grade_12" | "inter_grade_9" | "inter_grade_10" | "inter_grade_11" | "inter_grade_12";
        /** UserInfo */
        UserInfo: {
            /** Id */
            id: number;
...
export interface operations {
    ...
    list_clubs_summary_api_v1_clubs_summary_get: {
        parameters: {
            query?: {
                search?: string | null;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Page_ClubSummaryInfo_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    get_moderation_pending_summary_api_v1_moderations_summary_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ModerationPendingSummary"];
                };
            };
            /** @description Unauthorized or Token invalid */
            401: {
